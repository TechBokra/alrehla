...
import { DateRangeField, type DateRangeValue } from "../../fields/core/date-range-field";

export interface FormDateRangeProps extends FormFieldPresentationProps {
  placeholder?: string | undefined;
  disabled?: boolean | undefined;
}

export function FormDateRange({ label, description, required, placeholder, disabled, className }: FormDateRangeProps) {
