        ...
        fields: [
          {
            ...
            type: 'input',
            placeholder: 'منصة الرحلة. جميع الحقوق محفوظة.',
          },
          {
            key: 'footer.description',
            label: 'وصف مختصر (يظهر تحت الشعار)',
            type: 'textarea',
            rows: 2,
          },
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            key: 'portalPage.enhaLakDescription',
            label: 'وصف بطاقة "إنها لك"',
            type: 'textarea',
            rows: 2,
          },
          ...
          {
            key: 'portalPage.creativeWritingTitle',
            label: 'عنوان بطاقة "بداية الرحلة"',
            type: 'input',
          },
          {
            key: 'portalPage.creativeWritingDescription',
            label: 'وصف بطاقة "بداية الرحلة"',
            type: 'textarea',
            rows: 2,
          },
          {
            key: 'portalPage.creativeWritingBtnText',
            label: 'نص زر "بداية الرحلة"',
            type: 'input',
          },
          {
            key: 'siteBranding.creativeWritingPortalImageUrl',
            label: 'صورة خلفية بطاقة "بداية الرحلة"',
            type: 'image',
          },
        ],
      },
      ...
      },
      {
        ...
        fields: [
          ...
          {
            key: 'portalPage.aboutSectionContent',
            label: 'محتوى القسم',
            type: 'textarea',
            rows: 4,
          },
    ...
    sections: [
      {
        ...
        description:
          'ملاحظة: صور عرض المنتجات (صندوق الرحلة والقصة) تسحب تلقائياً من إدارة المنتجات.',
        fields: [
          { key: 'enhaLakPage.main.heroTitle', label: 'العنوان الرئيسي', type: 'input' },
          {
            key: 'enhaLakPage.main.heroSubtitle',
            label: 'النص التعريفي',
            type: 'textarea',
            rows: 2,
          },
      ...
      },
      {
        ...
        fields: [
          ...
          {
            key: 'enhaLakPage.store.subscriptionBannerTitle',
            label: 'عنوان بانر الاشتراك',
            type: 'input',
          },
        ],
      },
      {
        ...
        fields: [
          ...
          {
            key: 'enhaLakPage.subscription.heroSubtitle',
            label: 'النص التعريفي',
            type: 'textarea',
            rows: 2,
          },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          {
            key: 'creativeWritingPage.main.heroSubtitle',
            label: 'النص التعريفي',
            type: 'textarea',
            rows: 2,
          },
          {
            key: 'creativeWritingPage.main.methodologyTitle',
            label: 'عنوان المنهجية',
            type: 'input',
          },
          {
            key: 'creativeWritingPage.main.methodologySubtitle',
            label: 'وصف المنهجية',
            type: 'textarea',
            rows: 2,
          },
          {
            key: 'creativeWritingPage.main.transformationTitle',
            label: 'عنوان التحول',
            type: 'input',
          },
          ...
          {
            key: 'creativeWritingPage.main.instructorsTitle',
            label: 'عنوان المدربين',
            type: 'input',
          },
        ],
      },
      {
        ...
        fields: [
          ...
          {
            key: 'creativeWritingPage.about.heroSubtitle',
            label: 'النص التعريفي',
            type: 'textarea',
            rows: 2,
          },
          ...
          {
            key: 'creativeWritingPage.about.mainContent',
            label: 'المحتوى التفصيلي',
            type: 'textarea',
            rows: 6,
          },
          {
            key: 'creativeWritingPage.about.heroImageUrl',
            label: 'صورة عرض الفلسفة',
            type: 'image',
          },
        ],
      },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description:
          'لتوزيع الأسئلة على التبويبات، استخدم الكلمات المفتاحية في حقل "التصنيف": (إنها لك، شحن، منتجات) للتبويب الأول، و (بداية الرحلة، مدرب، جلسة) للتبويب الثاني. أي شيء آخر سيظهر في "عام".',
        fields: [
          {
            ...
            objectSchema: [
              ...
              {
                key: 'category',
                label: 'التصنيف (إنها لك / بداية الرحلة / عام)',
                type: 'input',
