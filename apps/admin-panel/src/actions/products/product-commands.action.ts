...
/**
 * Command: create a new personalized product
 */
...
/**
 * Command: update an existing personalized product
 */
...
/**
 * Command: delete a personalized product
 */
...
/**
 * Command: approve or reject a personalized product
 */
...
// Aliases with Action suffix
export const createPersonalizedProductAction = createPersonalizedProduct;
export const updatePersonalizedProductAction = updatePersonalizedProduct;
export const deletePersonalizedProductAction = deletePersonalizedProduct;
export const approveProductAction = approveProduct;
