...
const StudentLayout: React.FC<{ children?: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-100" dir="rtl">
            ...
            */}
            <header className="bg-white shadow-md sticky top-0 z-30 transition-all">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-gray-800">أهلاً بك، {displayName}</h1>
                                {isLoading ? (
            ...
            */}
            <div className="bg-white border-b sticky top-20 z-20 transition-all">
