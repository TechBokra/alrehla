...
const Image = React.forwardRef<HTMLImageElement, ImageProps>(
  (
    ...
    const cloudinaryPublicId = isCloudinaryUrl
      ? cloudinaryService.getPublicIdFromUrl(currentSrc)
      : null;
      ...
      >
        ...
        {isCloudinaryUrl && cloudinaryPublicId ? (
          <AlhrelaImage
            ...
            priority={priority}
            // @ts-ignore - next-cloudinary forwards to the underlying image element.
            ref={ref}
            {...(props as any)}
          />
        ) : (
          <NextImage
            ...
            priority={priority}
            className={cn(transitionClass, objectFitClass, opacityClass)}
            // @ts-ignore - next/image forwards to the underlying image element.
            ref={ref}
            {...(props as any)}
          />
        )}
