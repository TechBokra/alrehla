...
const SessionReportPage: React.FC = () => {
    ...
    if (!session) return <div className="p-20 text-center text-muted-foreground">عذراً، لم يتم العثور على الجلسة.</div>;
    ...
    return (
        <div className="bg-muted/30 min-h-screen py-12 animate-fadeIn" dir="rtl">
            <div className="container mx-auto px-4 max-w-3xl">
                <button onClick={() => router.back()} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground font-bold mb-8 transition-colors">
                    <ArrowRight size={18} />
                    العودة للوحة التحكم
                </button>
